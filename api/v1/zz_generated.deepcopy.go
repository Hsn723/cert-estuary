...
func (in *ESTAuthorizedClientSpec) DeepCopyInto(out *ESTAuthorizedClientSpec) {
	*out = *in
	...
	out.PresharedKeyRef = in.PresharedKeyRef
	if in.Duration != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PresharedKeyRef) DeepCopyInto(out *PresharedKeyRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PresharedKeyRef.
func (in *PresharedKeyRef) DeepCopy() *PresharedKeyRef {
	if in == nil {
		return nil
	}
	out := new(PresharedKeyRef)
	in.DeepCopyInto(out)
	return out
}
